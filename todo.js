...
// 2-Yazacağınız JavaScript kodu içerisinde element eklemeyi sağlayan bir fonksiyon, element silmeyi sağlayan bir fonksiyon, yapıldı işaretlenmesini sağlayan bir fonksiyon olması gerekiyor.
// 3-Element eklendiğinde ve hata verirken sağ üstte uyarı verdiğini fark etmişsinizdir. Bunu sağlayan Bootstrap Toast bildirimdir. Sayfaya gidip toast nedir nasıl yapılır bunu araştırın ve kodunuza ekleyin.
// 4-Önce ana fonksiyonlar için uğraşın. Yapıldı, toast bildirim bunlar biraz daha işin artistliği. Öncelikli amacını sağlıyor olması lazım.
// 5-Yazdığınız js dosyasını projenize eklemeyi unutmayın.
// 6-Yaptığınız yapıya Local Storage'ı da ekleyip verilerin kaybolmamasını sağlayın.

// Her element için kapat butonu eklemek
